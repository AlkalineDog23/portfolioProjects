        ...
        If (playerTurn = True) Then
            ...
            ElseIf (rollsLeft > 0) And (rollsLeft < 3) Then
                ...
                If boolVar = 1 Then
                        rollsLeft = 0
                        lblNumRollsActual.Text = rollsLeft.ToString
                        MessageBox.Show("Attention, Entry move executed click roll to end turn", "Turn Over",
                               MessageBoxButtons.OK, MessageBoxIcon.Information)
                    End If
            ...
            ElseIf rollsLeft = 0 Then
                ...
                Else
                    ...
                    MessageBox.Show("TURN OVER, Please click roll to start next turn!", "Turn Over",
                                MessageBoxButtons.OK, MessageBoxIcon.Information)
